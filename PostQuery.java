...
public class PostQuery extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String qtype=request.getParameter("selqtype");
            String query=request.getParameter("tbq");
            ...
            PreparedStatement ps=conn.prepareStatement("Insert Into Postqueries(uid,qtype,query,qdate)Values(?,?,?,?)");
            ps.setString(1, uid);
            ...
            if(k>0)
            {
            out.println("Query Posted Succesfully... ");
            }
            else
            {
