...
public class PostSuccessServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            PreparedStatement ps=conn.prepareStatement("Insert Into Postanswer(qid,qans,uid)Values(?,?,?)");
            ps.setInt(1, qid);
            ps.setString(2, qans);
            ps.setString(3, uid);
            ...
            {
            out.println("Answer Not Posted Successfully...");
            }       
